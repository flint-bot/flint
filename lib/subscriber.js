...
function Subscriber(flint) {
  ...
  $this.server.route('get', $this._webhookResource + '/:route', responder);
  $this.server.route('post', $this._webhookResource + '/:route', responder);
  $this.server.route('put', $this._webhookResource + '/:route', responder);
  $this.server.route('del', $this._webhookResource + '/:route', responder);
...
Subscriber.prototype.create = function(name, cb) {
  ...
  var webhook = $this._webhookUrl + $this._webhookResource + '/' + name;
