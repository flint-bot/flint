...
Flint.prototype.auditBots = function() {
  ...
  if(this.auditcounter === 0) {
    this.getPerson(this.person.email)
      ...
      .catch(err => this.debug(err.message));
  }
...
Flint.prototype.getTrigger = function(messageId) {
   ...
   * @property {array} mentionedPeople - Mentioned People
  ...
  return this.getMessage(messageId)
    .then(message => {
      ...
      trigger.mentionedPeople = message.mentionedPeople || null;
              ...
              .then(authorized => {
                ...
                if(authorized) {
                  ...
                  _.forEach(matched, match => {
                    match.action(bot, trigger, this.id);
                  });
