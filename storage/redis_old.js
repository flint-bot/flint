...
function Storage(connectionUrl, name) {
  connsole.log('The redis.js storage module is deprecated. Consider migrating to redis2.js storsge module which is interchangable with the memory storage module.');
